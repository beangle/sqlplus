...
ThisBuild / version := "0.0.32-SNAPSHOT"
...
val beangle_commons_core = "org.beangle.commons" %% "beangle-commons-core" % "5.6.10-SNAPSHOT"
val beangle_data_jdbc = "org.beangle.data" %% "beangle-data-jdbc" % "5.8.0-SNAPSHOT"
val beangle_template_freemarker = "org.beangle.template" %% "beangle-template-freemarker" % "0.1.10-SNAPSHOT"
