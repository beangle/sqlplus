...
val beangle_commons_core = "org.beangle.commons" %% "beangle-commons-core" % "5.6.4"
val beangle_data_jdbc = "org.beangle.data" %% "beangle-data-jdbc" % "5.7.5"
val beangle_template_freemarker = "org.beangle.template" %% "beangle-template-freemarker" % "0.1.7"
