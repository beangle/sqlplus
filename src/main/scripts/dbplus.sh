...
download org.beangle.db beangle-db-plus_3 $beangle_db_ver

jarfile="$M2_REPO/org/beangle/db/beangle-db-plus_3/$beangle_db_ver/beangle-db-plus_3-$beangle_db_ver.jar"
